...
## Background
This GitHub repo was established in Fall 2025 to support underlying documentation behind my Oxford doctoral work titled: *Methods for phenotyping complex diseases across a network of real-world databases*. I vivaed and successfully defended in November 2025 and doctoral studies will be awarded in 2026. The information collated in this repo represents a validation effort to support recreation of the @ohdsi community method for large-scale chart adjudication review titled, [Knowledge-Enhanced Electronic ProfilE Review system (KEEPER)](https://ohdsi.github.io/Keeper/). 
